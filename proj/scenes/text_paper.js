	...
	var viking_img= [
		'url(img/bip.jpg)',
		'url(img/ber_most.jpg)',
		'url(img/mar_prud.jpg)',
		'url(img/st_r.jpg)',
		'url(img/st_rek.jpg)',
		'url(img/st_k.jpg)',
		'url(img/st_ev.jpg)',
	...
	var viking_text_modal = [
		'Мариенталь, неформально также Бибс или Бип — архитектурный каприз Павла I у развилки рек Славянка и Тызва в южной части Павловска. Представляет собой двухэтажный замок (в плане пятиугольный) с двумя башнями (в плане овальными) и внутренним двором. Вокруг по всем правилам бастионной системы устроены земляные фортификации (бастионы, равелины, люнеты, флеши).',
